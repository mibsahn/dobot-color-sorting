<<<<<<< HEAD
function [vertex,face,faceNormals,plot_h] = RectangularPrism(lower,upper,plotOptions,axis_h)
if nargin<4
        axis_h=gca;
    if nargin<3
...
if isfield(plotOptions,'plotVerts') && plotOptions.plotVerts
    for i=1:size(vertex,1);
        plot_h.vert = plot3(vertex(i,1),vertex(i,2),vertex(i,3),'r*');
...
if isfield(plotOptions,'plotEdges') && plotOptions.plotEdges
    ...
    for i=1:size(links,1)
        plot_h.edges = plot3(axis_h,[vertex(links(i,1),1),vertex(links(i,2),1)],...
...
if isfield(plotOptions,'plotFaces') && plotOptions.plotFaces
    ...
    plot_h.faces = patch('Faces',face,'Vertices',vertex,'FaceVertexCData',tcolor,'FaceColor','flat','lineStyle','none');
end
...
>>>>>>> d25c043cc6a44ae63f6bf4eb407d79e88b465f46
end